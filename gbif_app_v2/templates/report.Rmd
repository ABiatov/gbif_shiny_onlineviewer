...
`r if (  !is.null(nrow_chku()) && !is.na(nrow_chku()) && !is.nan(nrow_chku()) && nrow_chku() > 0  ) {  paste0("## Кількість видів занесених до Червоної книги України: ", toString(nrow_chku()) ) } else {" "} `
...
## Загальний перелік видів
`r paste0("Загальна кількість видів: ", toString(nrow(df_report_table())) ) `
