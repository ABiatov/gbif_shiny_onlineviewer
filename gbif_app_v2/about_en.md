**Biodiversity Viewer** is an online tool that provides quick and convenient access to data on registration of species subject to special protection in accordance with Ukrainian legislation and published on the [GBIF](https://www.gbif.org/). It is open source software distributed under the [*MIT License*](https://opensource.org/license/mit), so users can deploy it on their own server or local computer, modify or adapt for any other country.
