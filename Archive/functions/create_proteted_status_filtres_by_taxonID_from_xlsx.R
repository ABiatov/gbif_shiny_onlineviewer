...
xl_file_name <- "rdb_ua.xlsx"
redbook_status_field <- "threatStatus"
...
# "вразливий"
red_book_vrazlyvyi <- subset(df_protected_status, df_protected_status[[redbook_status_field]] == "вразливий")[[taxonID_field]]

# "рідкісний" 
red_book_ridkisnyi <- subset(df_protected_status, df_protected_status[[redbook_status_field]] == "рідкісний")[[taxonID_field]]

# "зникаючий"
red_book_znykaiuchyi <- subset(df_protected_status, df_protected_status[[redbook_status_field]] == "зникаючий")[[taxonID_field]]


# "зниклий"
red_book_znyklyi <- subset(df_protected_status, df_protected_status[[redbook_status_field]] == "зниклий")[[taxonID_field]]


# "зниклий в природі"
red_book_znyklyi_v_pryrodi <- subset(df_protected_status, df_protected_status[[redbook_status_field]] == "зниклий в природі")[[taxonID_field]]


# "недостатньо відомий"
red_book_nedostatno_vidomyi <- subset(df_protected_status, df_protected_status[[redbook_status_field]] == "недостатньо відомий")[[taxonID_field]]


# "неоцінений"
red_book_neotsinenyi <- subset(df_protected_status, df_protected_status[[redbook_status_field]] == "неоцінений")[[taxonID_field]]

# # BernAppendix2
# bern_appendix_2 <- subset(df_protected_status, BernAppendix2 == "yes")[[taxonID_field]]
# 
# # BernAppendix3
# bern_appendix_3 <- subset(df_protected_status, BernAppendix3 == "yes")[[taxonID_field]]
# 
# # BernResolution6
# bern_resolution_6 <- subset(df_protected_status, BernResolution6 == "yes")[[taxonID_field]]
# 
# # ЧС_Полтавська
# redlist_poltavska <- subset(df_protected_status, ЧС_Полтавська == "yes")[[taxonID_field]]
# 
# # ЧС_Чернівецька
# redlist_chernivetska <- subset(df_protected_status, ЧС_Чернівецька == "yes")[[taxonID_field]]
# 
# # Invasive
# invasive_specieses <- subset(df_protected_status, Invasive == "yes")[[taxonID_field]]
